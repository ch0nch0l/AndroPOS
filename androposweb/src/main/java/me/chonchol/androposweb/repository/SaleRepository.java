...
public interface SaleRepository extends JpaRepository<Sale, Integer> {
    ...
    @Query(value = " SELECT new me.chonchol.androposweb.entity.report.SaleReport(B.order_date , E.customer_name, E.phone_no, " +
            ...
            " WHERE (B.order_date BETWEEN :from_date AND :to_date) ", nativeQuery = false)
