...
import me.chonchol.andropos.adapter.SplashViewPagerAdapter;
import me.chonchol.andropos.sharedpref.SplashSharedPref;
...
public class SplashActivity extends AppCompatActivity {
    ...
    private SplashSharedPref pref;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);

        pref = new SplashSharedPref(getApplicationContext());
        ...
        adapter = new SplashViewPagerAdapter(getApplicationContext(), layouts);
